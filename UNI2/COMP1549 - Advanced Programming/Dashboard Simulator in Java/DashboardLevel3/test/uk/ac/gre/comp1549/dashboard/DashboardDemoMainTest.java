...
public class DashboardDemoMainTest {
    ...
    public void testSetPetrol1() {
        ...
        pause();
        assertEquals(dashboard.indicatorFuel.getValue(), 100);
    }
    ...
    public void testSetPetrol2() {
        ...
        pause();
        assertEquals(dashboard.indicatorFuel.getValue(), 0);
    }
    ...
    public void testSetAltitude1() {
        ...
        pause();
        assertEquals(dashboard.indicatorAltitude.getValue(), 99);
    }
    ...
    public void testSetAltitude2() {
        ...
        pause();
        assertEquals(dashboard.indicatorAltitude.getValue(), 100);
    }
    ...
    public void testSetAltitude3() {
        ...
        pause();
        assertEquals(dashboard.indicatorAltitude.getValue(), 0);
    }
