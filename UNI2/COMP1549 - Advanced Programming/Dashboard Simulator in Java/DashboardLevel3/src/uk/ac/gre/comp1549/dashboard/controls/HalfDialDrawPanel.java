...
/**
 * DialDrawPanel. Draw a half dial and indicate current value.
 *
 * @author Gyokay Ali
 * @version 1.0
 */
public class HalfDialDrawPanel extends JPanel implements InterfaceGetSetMethods,InterfaceDrawHands {
