...
import uk.ac.gre.comp1549.dashboard.designpatterns.SingletonConverter;
...
public class DashboardEventGeneratorFromXML extends DefaultHandler {
    ...
    public void processScriptFile(String filename) throws IOException, SAXException {
        ...
        //get the static instance of the SingletonConvertor class
        SingletonConverter single = SingletonConverter.getInstance();
        ...
        xmlReader.parse(single.convertToFileURL(filename));
    }
