...
/**
 * DigitalDisplayBarDrawPanel.  Draw a horizontal bar indicator and show its current value
 *
 * @author Gyokay Ali
 * @version 2.0
 * 
 * CURRENTLY NOT IN USE, BECAUSE OF THE NEWLY IMPLEMENTED JAVA BEAN AS A DIGITAL DISPLAY
 */
public class DigitalDisplayBarDrawPanel extends JPanel implements InterfaceGetSetMethods {
