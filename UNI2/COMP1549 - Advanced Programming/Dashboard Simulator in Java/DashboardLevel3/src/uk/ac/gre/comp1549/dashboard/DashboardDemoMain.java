...
import uk.ac.gre.comp1549.dashboard.controls.InterfaceGetSetMethods;
...
public class DashboardDemoMain extends JFrame {
    ...
    InterfaceGetSetMethods indicatorAltitude, indicatorFuel, indicatorSpeed, indicatorTemp, indicatorOil;
    ...
    public DashboardDemoMain() {
        ...
        //add the fuel indicator
        indicatorAltitude = FactoryIndicator.getIndicator("ALTITUDE");
        indicatorAltitude.setLabel("ALTITUDE");
        dashboard.add((Component) indicatorAltitude);

        //add the fuel indicator
        indicatorFuel = FactoryIndicator.getIndicator("FUEL");
        indicatorFuel.setValue(100);
        indicatorFuel.setLabel("FUEL");
        dashboard.add((Component) indicatorFuel);
    ...
    private void runXMLScript() {
        try {
            ...
            DashBoardEventListener dbelPetrol = new DashBoardEventListener() {
                @Override
                public void processDashBoardEvent(Object originator, DashBoardEvent dbe) {
                    indicatorFuel.setValue(Integer.parseInt(dbe.getValue()));
                }
            };
            ...
            DashBoardEventListener dbelAltitude = new DashBoardEventListener() {
                @Override
                public void processDashBoardEvent(Object originator, DashBoardEvent dbe) {
                    indicatorAltitude.setValue(Integer.parseInt(dbe.getValue()));
                }
            };
    ...
    public void setAltitude() {
        try {
            ...
            indicatorAltitude.setValue(value);
