...
/**
 * BarDrawPanel.  Draw a vertical bar indicator and show its current value
 *
 * @author Gyokay Ali and Gill Windall
 * @version 3.0
 */
public class BarDrawPanel extends JPanel implements InterfacePanels  {
    ...
    private JLabel lblTitle; //the indicator's title
    /**
