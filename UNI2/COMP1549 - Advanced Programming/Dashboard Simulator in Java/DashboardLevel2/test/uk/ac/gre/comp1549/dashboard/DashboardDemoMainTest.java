...
public class DashboardDemoMainTest {
    ...
    public void testSetSpeed1() {
        ...
        pause();
        assertEquals(dashboard.speedDial.getValue(), 20);
    }
    ...
    public void testSetSpeed2() {
        ...
        pause();
        assertEquals(dashboard.speedDial.getValue(), 0);
    }
    ...
    public void testSetSpeed5() {
        ...
        pause();
        assertEquals(dashboard.speedDial.getValue(), 100);
    }
    ...
    public void testSetTemp1() {
        ...
        pause();
        assertEquals(dashboard.tempDial.getValue(), 55);
    }
    ...
    public void testSetTemp2() {
        ...
        pause();
        assertEquals(dashboard.tempDial.getValue(), 0);
    }
    ...
    public void testSetTemp5() {
        ...
        pause();
        assertEquals(dashboard.tempDial.getValue(), 100);
    }
    ...
    public void testSetOil1() {
        ...
        pause();
        assertEquals(dashboard.oilBar.getValue(), 80);
    }
    ...
    public void testSetOil2() {
        ...
        dashboard.txtOilValueInput.setText("-80");
        pause();
        assertEquals(dashboard.oilBar.getValue(), 0);
    }
    ...
    public void testSetOil3() {
        ...
        pause();
        assertEquals(dashboard.oilBar.getValue(), 100);
    }
    ...
    public void testSetPetrol1() {
        ...
        pause();
        assertEquals(dashboard.petrolDial.getValue(), 100);
    }
    ...
    public void testSetPetrol2() {
        ...
        pause();
        assertEquals(dashboard.petrolDial.getValue(), 0);
    }
    ...
    public void testSetAltitude1() {
        ...
        pause();
        assertEquals(dashboard.altitudeBar.getValue(), 99);
    }
    ...
    public void testSetAltitude2() {
        ...
        pause();
        assertEquals(dashboard.altitudeBar.getValue(), 100);
    }
    ...
    public void testSetAltitude3() {
        ...
        pause();
        assertEquals(dashboard.altitudeBar.getValue(), 0);
    }
