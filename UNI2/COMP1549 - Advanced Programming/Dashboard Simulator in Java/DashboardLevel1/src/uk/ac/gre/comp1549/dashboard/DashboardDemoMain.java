...
public class DashboardDemoMain extends JFrame {
    ...
    private JTextField txtPetrolValueInput, txtTempValueInput, txtSpeedValueInput, txtOilValueInput;
    private JButton btnScript;

    // fields that appear on the dashboard itself
    private DialPanel speedDial;
    private HalfDialPanel petrolDial, tempDial;
    private BarPanel oilBar;
