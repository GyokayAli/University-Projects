...
/**
 * HalfDialPanel.  Container for HalfDialDrawPanel to hold dial and label.
 * If a label is not needed DialDrawPanel an be used on its own
 *
 * @author Gyokay Ali
 * @version 1.0
 */
public class HalfDialPanel extends JPanel {

    private HalfDialDrawPanel dial;  // the dial itself
