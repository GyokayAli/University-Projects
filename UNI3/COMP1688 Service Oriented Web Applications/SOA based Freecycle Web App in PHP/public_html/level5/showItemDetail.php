...
include 'include/filter.php';
    ...
    $output .= '<br/><table id="table1" border="1" width="50%">
        ...
        $title = $doc->firstChild->getElementsByTagName("title") ->item($i)->nodeValue;
        $descr = $doc->firstChild->getElementsByTagName("descr") ->item($i)->nodeValue;
        $post_date = $doc->firstChild->getElementsByTagName("post_date") ->item($i)->nodeValue;
    ...
    $output .= '</table>';
    // table 2
    $output .= '<br/><table id="table 2" border="1" width="50%">
                <thead>
                        <tr>
                            <th>Posted by</th>
                            <th>Postcode</th>
