...
$url = 'http://stuweb.cms.gre.ac.uk/~ag306/level0/proxy.php?keyword='.$nq;
...
$imgID = $value->imgID;
		...
		if(substr($itemID,0,3) == "gre" || substr($itemID,0,3) == "lew"){ // if item from GRE or LEW
			$output .=	"<a href='http://stu-nginx.cms.gre.ac.uk/~ag306/level5/showItemDetail.php?itemID=$itemID'>$title</a>";
		}
		else{
			$output .=	"<a href='http://stuweb.cms.gre.ac.uk/~ag306/level0/showItemDetail.php?itemID=$itemID'>$title</a>";
		}
		$output .= "</td>
					<td>$descr</td>
					<td>$post_date</td>
					<td>$postcode</td>";
		if(substr($imgID,0,3) == 'gre'){
			$output .=	'<td><img src="http://stuweb.cms.gre.ac.uk/~ag306/level3/getImage.php?imgID='.$imgID.'" alt="" /></td>';
		}
		if(substr($imgID,0,3) == 'lew'){
			$output .=	'<td><img src="http://stuiis.cms.gre.ac.uk/ag306/myroot/level2/freecycle/GetImage.ashx?imgID='.$imgID.'" alt="" /></td>';
		}
		if(substr($itemID,0,3) == 'bro'){
...
<div class="wrapper col1">
  <div id="header">
    <div id="logo">
      ...
      <p><i>Greenwich, Lewisham and Bromley</i></p>
    </div>
    <div id="topnav">
      <ul>
  ...
  <div id="container">
    <div class="homepage">
		...
		<div class="center">
         ...
         <h2>Portal for Greenwich, Lewisham and Bromley</h2>
